...
if(item == 495)
{
var Wither = Level.spawnMob(x, y+1, z, 34, "mob/wither.png");
...
if(victim == 32)
{
Level.dropItem(Entity.getX(victim), Entity.getY(victim) + 1, Entity.getZ(victim), 0, 506, 2, 0);
}
if(victim == 35)
{
Level.dropItem(Entity.getX(victim), Entity.getY(victim) + 1, Entity.getZ(victim), 0, 505, 2, 0);
}
if(victim == Wolf)
{
Level.dropItem(Entity.getX(victim), Entity.getY(victim) + 1, Entity.getZ(victim), 0, 35, 2, 0);
}
}
